...
#Example: s3_path = 's3://<BUCKET_NAME>/<FOLDER_NAME>'
s3_path = ''

datasink1 = dropnullfields3.toDF().coalesce(1)
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": s3_path, "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
